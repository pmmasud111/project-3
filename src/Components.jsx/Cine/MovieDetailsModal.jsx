        ...
        <div className="bg-white shadow-md  rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
          ...
          <div className="p-5 lg:p-11">
            ...
            <div className="grid lg:grid-cols-2 gap-2">
              ...
              <a
                className="border bg-gray-200  border-[#646c52] rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#6F6F6F] dark:text-gray-500 font-semibold text-sm"
                href="#"
                onClick={onClose}
              >
                Cancel
